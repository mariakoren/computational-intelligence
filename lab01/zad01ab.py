...
misiacUrodzenia = int(input("podaj miesiąc urodzenia: "))
...
dataUrodzenia = datetime.datetime(rokUrodzenia, misiacUrodzenia, dzienUrodzenia)
...
#a
print(f"witaj {imie}")
print(f'urodziałeś sie {dataUrodzenia}')
...
#na pisanie a-b spędziłam około 30 minut
